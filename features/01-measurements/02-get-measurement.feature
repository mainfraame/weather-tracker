Feature: Get a measurement
  ...
  @new
  Scenario: Cannot get a measurement without a timestamp
    # GET /measurements/
    When I get a measurement for ""
    Then the response has a status code of 405

  @new
  Scenario: Cannot get a measurement with an invalid timestamp
    # GET /measurements/2015-25-21T53:50:00.000Z
    When I get a measurement for "2015-25-21T53:50:00.000Z"
    Then the response has a status code of 400

  @new
  Scenario: Get a measurement with a valid timestamp that is uri encoded
    # GET /measurements/2015-09-01T16%3A20%3A00.000Z
    When I get a measurement for "2015-09-01T16%3A20%3A00.000Z"
    Then the response has a status code of 200
    And the response body is:
      | timestamp                  | temperature | dewPoint | precipitation |
      | "2015-09-01T16:20:00.000Z" | 27.5        | 17.1     | 0             |
