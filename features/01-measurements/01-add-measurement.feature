Feature: Add a measurement
  ...
  @new
  Scenario: Add a measurement with duplicate timestamp
    # POST /measurements
    When I submit a new measurement as follows:
      | timestamp                  | temperature | dewPoint | precipitation |
      | "2015-09-01T16:00:00.000Z" | 26.1        | 14.1     | 1             |
    Then the response has a status code of 201
    And the Location header has the path "/measurements/2015-09-01T16:00:00.000Z"

  @new
  Scenario: Add a measurement with a valid timestamp and at least one valid metric
    # POST /measurements
    When I submit a new measurement as follows:
      | timestamp                  | temperature |
      | "2015-09-01T16:00:00.000Z" | 27.1        |
    Then the response has a status code of 201
    And the Location header has the path "/measurements/2015-09-01T16:00:00.000Z"

  @new
  Scenario: Add a measurement with a valid timestamp and new metric
    # POST /measurements
    When I submit a new measurement as follows:
      | timestamp                  | airSpeed |
      | "2015-09-01T16:00:00.000Z" | 27.1     |
  ...
  @new
  Scenario: Cannot add a measurement without a valid timestamp
    # POST /measurements
    When I submit a new measurement as follows:
      | timestamp                  | temperature |
      | "2015-29-99T43:00:00.000Z" | 27.1        |
    Then the response has a status code of 400

  @new
  Scenario: Cannot add a measurement without metrics
    # POST /measurements
    When I submit a new measurement as follows:
      | timestamp                  |
      | "2015-29-99T43:00:00.000Z" |
    Then the response has a status code of 400
